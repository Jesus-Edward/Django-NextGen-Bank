...
class User(AbstractUser):
    ...
    security_question = models.CharField(_("Security Question"), max_length=100, choices=SecurityQuestion.choices)
    ...
    middle_name = models.CharField(_("Middle Name"), blank=True, max_length=50, null=True)
    last_name = models.CharField(_("Last Name"), blank=True, max_length=50)
    id_no = models.PositiveBigIntegerField(_("ID No"), unique=True)
    account_status = models.CharField(_("Account Status"), max_length=50, choices=AccountStatus.choices)
    ...
    def habdle_failed_login_attempt(self) -> None:
    ...
    def reset_failed_failed_login_attempts(self) -> None:
